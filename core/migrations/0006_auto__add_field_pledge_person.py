...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Pledge.person'
        db.add_column(u'core_pledge', 'person',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['core.Person']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Deleting field 'Pledge.person'
        db.delete_column(u'core_pledge', 'person_id')
