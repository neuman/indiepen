...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Project.upfront'
        db.add_column(u'core_project', 'upfront',
                      self.gf('django.db.models.fields.FloatField')(default=400),
                      keep_default=False)


        # Changing field 'Media.brief'
        db.alter_column(u'core_media', 'brief', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):
        # Deleting field 'Project.upfront'
        db.delete_column(u'core_project', 'upfront')


        # Changing field 'Media.brief'
        db.alter_column(u'core_media', 'brief', self.gf('django.db.models.fields.TextField')())
