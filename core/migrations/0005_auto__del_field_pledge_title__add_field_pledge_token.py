...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Pledge.title'
        db.delete_column(u'core_pledge', 'title')

        # Adding field 'Pledge.token'
        db.add_column(u'core_pledge', 'token',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=300),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Pledge.title'
        db.add_column(u'core_pledge', 'title',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=300),
                      keep_default=False)

        # Deleting field 'Pledge.token'
        db.delete_column(u'core_pledge', 'token')
