...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'HistoricalProject.approved'
        db.add_column(u'core_historicalproject', 'approved',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'HistoricalProject.first_id'
        db.add_column(u'core_historicalproject', u'first_id',
                      self.gf('django.db.models.fields.IntegerField')(db_index=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Project.approved'
        db.add_column(u'core_project', 'approved',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Project.first'
        db.add_column(u'core_project', 'first',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'core_project_related', null=True, to=orm['core.Post']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'HistoricalProject.approved'
        db.delete_column(u'core_historicalproject', 'approved')

        # Deleting field 'HistoricalProject.first_id'
        db.delete_column(u'core_historicalproject', u'first_id')

        # Deleting field 'Project.approved'
        db.delete_column(u'core_project', 'approved')

        # Deleting field 'Project.first'
        db.delete_column(u'core_project', 'first_id')
