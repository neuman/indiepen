...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'core_media', 'importance',
                      self.gf('django.db.models.fields.CharField')(default='medium', max_length=3),
                      keep_default=False)


        # Changing field 'Media.sort_order'
        db.alter_column(u'core_media', 'sort_order', self.gf('django.db.models.fields.PositiveIntegerField')())
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Media.sort_order'
        db.alter_column(u'core_media', 'sort_order', self.gf('django.db.models.fields.IntegerField')())
    ...
    models = {
        ...
        u'core.media': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'importance': ('django.db.models.fields.CharField', [], {'default': "'medium'", 'max_length': '3'}),
