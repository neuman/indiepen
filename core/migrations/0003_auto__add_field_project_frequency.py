...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Project.frequency'
        db.add_column(u'core_project', 'frequency',
                      self.gf('django.db.models.fields.CharField')(default='WEE', max_length=3),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Project.frequency'
        db.delete_column(u'core_project', 'frequency')
