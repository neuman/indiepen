...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Person.changed_by'
        db.alter_column(u'core_person', 'changed_by_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

        # Changing field 'Pledge.changed_by'
        db.alter_column(u'core_pledge', 'changed_by_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

        # Changing field 'Payout.changed_by'
        db.alter_column(u'core_payout', 'changed_by_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

        # Changing field 'Contribution.changed_by'
        db.alter_column(u'core_contribution', 'changed_by_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

        # Changing field 'Badge.changed_by'
        db.alter_column(u'core_badge', 'changed_by_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

        # Changing field 'Service.changed_by'
        db.alter_column(u'core_service', 'changed_by_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

        # Changing field 'Membership.changed_by'
        db.alter_column(u'core_membership', 'changed_by_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

        # Changing field 'Post.changed_by'
        db.alter_column(u'core_post', 'changed_by_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

        # Changing field 'Project.changed_by'
        db.alter_column(u'core_project', 'changed_by_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

        # Changing field 'Media.changed_by'
        db.alter_column(u'core_media', 'changed_by_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

    def backwards(self, orm):

        # Changing field 'Person.changed_by'
        db.alter_column(u'core_person', 'changed_by_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['core.Person']))

        # Changing field 'Pledge.changed_by'
        db.alter_column(u'core_pledge', 'changed_by_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['core.Person']))

        # Changing field 'Payout.changed_by'
        db.alter_column(u'core_payout', 'changed_by_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['core.Person']))

        # Changing field 'Contribution.changed_by'
        db.alter_column(u'core_contribution', 'changed_by_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['core.Person']))

        # Changing field 'Badge.changed_by'
        db.alter_column(u'core_badge', 'changed_by_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['core.Person']))

        # Changing field 'Service.changed_by'
        db.alter_column(u'core_service', 'changed_by_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['core.Person']))

        # Changing field 'Membership.changed_by'
        db.alter_column(u'core_membership', 'changed_by_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['core.Person']))

        # Changing field 'Post.changed_by'
        db.alter_column(u'core_post', 'changed_by_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['core.Person']))

        # Changing field 'Project.changed_by'
        db.alter_column(u'core_project', 'changed_by_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['core.Person']))

        # Changing field 'Media.changed_by'
        db.alter_column(u'core_media', 'changed_by_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['core.Person']))
